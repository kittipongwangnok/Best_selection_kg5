...
DP_Leo = open("dpleo_20161225_run024kg5.log",'r').readlines()
N_dpleo = len(DP_Leo)
...
for line in open("dpleo_20161225_run024kg5.log"):
...
for i in range(len(x)):
        print(i, tar[i],tar_err[i], ref[i], ref_err[i])
...
f = open("dpleo_20161225_run024kg5.dat", 'w')
